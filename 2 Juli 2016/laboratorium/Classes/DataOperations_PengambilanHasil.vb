...
Public Class DataOperations_PengambilanHasil
    Private PengambilanHasilDataTable As DataTable

#Region "Read ID dan ID Max"
    Public Function ReadIDPengambilanHasil() As Integer
        ...
        Using cmd As New SqlCommand With {.Connection = connection}
            cmd.CommandText = "SELECT ID FROM [pengambilan_hasil]"
    ...
    Public Function ReadMaxIDPengambilanHasil() As Integer
        Dim returnID As Integer
        Dim result As String

        Using cmd As New SqlCommand With {.Connection = connection}
            cmd.CommandText = "SELECT MAX(ID) FROM [pengambilan_hasil]"
...
#Region "Ambil data dari database untuk di tampilkan di form anak"
    Public Sub getDataPengambilanHasil(id As Integer)
        ...
        Using connection
            Dim command As SqlCommand = New SqlCommand( _
              ...
              "no_rekening, rekening_atas_nama, keterangan, direvisi_oleh, start_jam_revisi, end_jam_revisi FROM pengambilan_hasil " &
